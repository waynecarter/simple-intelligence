...
final class AppService {
    ...
    convenience init(database: CouchbaseLiteSwift.Database, collections: [CouchbaseLiteSwift.Collection], endpoint: AppService.Endpoint?, conflictResolver: ConflictResolverProtocol? = nil, identity: SecIdentity? = nil, ca: SecCertificate? = nil) {
        self.init(name: database.name, database: database, collections: collections, endpoint: endpoint, conflictResolver: conflictResolver, identity: identity, ca: ca)
    }
