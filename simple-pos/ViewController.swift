...
class ViewController: UICollectionViewController {
    ...
    private var addToCartButtonBottomContraint: NSLayoutConstraint!
    ...
    private func setupUI() {
        ...
        addToCartButtonBottomContraint = addToBagButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -margin.bottom)
        NSLayoutConstraint.activate([
            ...
            addToCartButtonBottomContraint
    ...
    @objc func keyboardWillShow(notification: NSNotification) {
        ...
        UIView.animate(withDuration: animationDuration) {
            self.collectionView.performBatchUpdates {
                self.addToCartButtonBottomContraint.constant = -(keyboardFrame.height + self.margin.bottom) + self.view.safeAreaInsets.bottom
    ...
    @objc func keyboardWillHide(notification: NSNotification) {
        ...
        UIView.animate(withDuration: animationDuration) {
            self.collectionView.performBatchUpdates {
                self.addToCartButtonBottomContraint.constant = -self.margin.bottom
                self.view.layoutIfNeeded()
            }
        }
    }
